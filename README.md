...
| 4.  | [Sentimentinator](https://github.com/Hardvan/Sentimentinator)                       | Web-based tool employing NLP techniques to categorize textual data into positive, negative, or neutral sentiments.                          |
| 5.  | [The OS-sential Guide](https://github.com/Hardvan/The-OS-sential-Guide)             | A comprehensive web-based guide to understand the concepts of OS, with interactive process scheduling simulations.                          |
| 6.  | [Paralyzed by Parallax](https://github.com/Hardvan/Paralyzed-by-Parallax)           | A collection of beautiful front-end designs involving parallax scrolling effects, magic hovers, and more.                                   |
| 7.  | [CipherNet](https://github.com/Hardvan/CipherNet)                                   | Cybersecurity website to educate users about encryption techniques like RSA, Morse Code and try them out in real-time.                      |
| 8.  | [Glucovisor](https://github.com/Hardvan/Glucovisor.git)                             | Diabetes prediction using a SVM model, with a web-based interface to enter the patient's data and get the prediction.                       |
| 9.  | [FaceCounter](https://github.com/Hardvan/FaceCounter)                               | A web-based tool to count & extract individual faces from a group photo, using OpenCV and Haar Cascades.                                    |
| 10. | [Text Scanner using EasyOCR](https://github.com/Hardvan/Text-Scanner-using-EasyOCR) | Extracts text from images using EasyOCR.                                                                                                    |
