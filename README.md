...
<p><img align="left" src="https://github-readme-stats.vercel.app/api/top-langs?username=hardvan&show_icons=true&locale=en&layout=compact&theme=dracula" height="170px" alt="hardvan" /></p>
<p>&nbsp;<img align="center" src="https://github-readme-stats.vercel.app/api?username=hardvan&show_icons=true&locale=en&theme=dracula" height="170px" alt="hardvan" /></p>
</div>
...
| #   | Project                                                                             | Description                                                                                                                                                                                                                                          |
| --- | ----------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.  | [Emotion Detector](https://github.com/Hardvan/EmotionDetector)                      | A concoction of Flask, OpenCV, and Deep Learning (CNN) to detect emotions from faces.                                                                                                                                                                |
| 2.  | [Hugging Face Playground](https://github.com/Hardvan/Hugging-Face-Playground)       | An experimental playground for trying out Hugging Face models in a intuitive & user-friendly manner.                                                                                                                                                 |
| 3.  | [ScanSpeaker](https://github.com/Hardvan/ScanSpeaker)                               | Instant extraction of text from images using OCR, coupled with Google's text-to-speech technology to convert the extracted text into speech.                                                                                                         |
| 4.  | [PolyPersona](https://github.com/Hardvan/PolyPersona)                               | Generate text & audio responses mimicking various celebrities, with options for language, model parameters customization, and seamless integration of gTTS, googletrans, and Gemini API.                                                             |
| 5.  | [Velocity Vault](https://github.com/Hardvan/Velocity-Vault)                         | Next-gen car showroom management system featuring automated appointment booking, sentiment analysis, text summarization, QR ID integration, & a crypto payment gateway, enhancing efficiency & customer interaction through innovative technologies. |
| 6.  | [Sentimentinator](https://github.com/Hardvan/Sentimentinator)                       | Web-based tool employing NLP techniques to categorize textual data into positive, negative, or neutral sentiments.                                                                                                                                   |
| 7.  | [The OS-sential Guide](https://github.com/Hardvan/The-OS-sential-Guide)             | A comprehensive web-based guide to understand the concepts of OS, with interactive process scheduling simulations.                                                                                                                                   |
| 8.  | [Paralyzed by Parallax](https://github.com/Hardvan/Paralyzed-by-Parallax)           | A collection of beautiful front-end designs involving parallax scrolling effects, magic hovers, and more.                                                                                                                                            |
| 9.  | [CipherNet](https://github.com/Hardvan/CipherNet)                                   | Cybersecurity website to educate users about encryption techniques like RSA, Morse Code and try them out in real-time.                                                                                                                               |
| 10. | [Glucovisor](https://github.com/Hardvan/Glucovisor.git)                             | Diabetes prediction using a SVM model, with a web-based interface to enter the patient's data and get the prediction.                                                                                                                                |
| 11. | [FaceCounter](https://github.com/Hardvan/FaceCounter)                               | A web-based tool to count & extract individual faces from a group photo, using OpenCV and Haar Cascades.                                                                                                                                             |
| 12. | [Text Scanner using EasyOCR](https://github.com/Hardvan/Text-Scanner-using-EasyOCR) | Extracts text from images using EasyOCR.                                                                                                                                                                                                             |
...
### How-Tos, Experiments & Useful Guides 📖

| #   | Project                                                                                                                     |
| --- | --------------------------------------------------------------------------------------------------------------------------- |
| 1.  | [How To Deploy a Flask App to Render](https://github.com/Hardvan/How-to-Deploy-a-Flask-App-to-Render.git)                   |
...
| 6.  | [FARM (FastAPI, React, MongoDB) Blog App Experimentation](https://github.com/Hardvan/FARM-FastAPI-React-MongoDB-Blog-App)   |
| 7.  | [FastAPI & k8s Experimentation](https://github.com/Hardvan/FastAPI-and-k8s-Experimentation)                                 |
| 8.  | [k8s & Spring Boot Experimentation](https://github.com/Hardvan/k8s-and-Spring-Boot-Experimentation.git)                     |
| 9.  | [Docker & Spring Boot Experimentation](https://github.com/Hardvan/Docker-and-Spring-Boot-Experimentation.git)               |
| 10. | [k8s & Flask Experimentation](https://github.com/Hardvan/k8s-and-Flask-Experimentation.git)                                 |
| 11. | [Docker & MERN Experimentation](https://github.com/Hardvan/Docker-and-MERN-Experimentation.git)                             |
| 12. | [k8s & MERN Experimentation](https://github.com/Hardvan/k8s-and-MERN-Experimentation.git)                                   |
| 13. | [Docker & Flask Experimentation](https://github.com/Hardvan/Docker-and-Flask-Experimentation.git)                           |
| 14. | [Trying Google Gemini API](https://github.com/Hardvan/Trying-Gemini-API.git)                                                |
| 15. | [Trying Google Bard Prompt Engineering](https://github.com/Hardvan/Google-Bard-Prompt-Engineering)                          |
| 16. | [Trying Flutter](https://github.com/Hardvan/Trying-Flutter.git)                                                             |
| 17. | [Flask & Firebase Experiment](https://github.com/Hardvan/Flask-and-Firebase-Experiment)                                     |
| 18. | [Trying Docker](https://github.com/Hardvan/Trying-Docker)                                                                   |
| 19. | [Mark It Down: How To Use Markdown](https://github.com/Hardvan/Mark-It-Down.git)                                            |
| 20. | [Learning PySpark](https://github.com/Hardvan/Learning-PySpark.git)                                                         |
